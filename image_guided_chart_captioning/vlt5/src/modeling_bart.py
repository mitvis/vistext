...
from transformers.modeling_outputs import (
    ModelOutput, BaseModelOutput, Seq2SeqLMOutput, Seq2SeqModelOutput
)
...
class JointEncoder(BartEncoder):
    ...
    def forward(
        ...
        hidden_states = torch.nn.functional.dropout(inputs_embeds, p=self.dropout, training=self.training)
...
class VLBartModel(BartModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Unlike other models, Bart automatically creates decoder_input_ids from
        ...
        # If a user passed a tuple for encoder_outputs, we wrap it in a 
        # BaseModelOutput when return_dict=False.
