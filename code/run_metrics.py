...
import nltk
nltk.data.path.append("./nltkgensimdata")
from nltk.corpus import stopwords
os.environ['GENSIM_DATA_DIR'] = "./nltkgensimdata/"
...
#     logging.basicConfig(level=logging.INFO)
    ...
    if args.no_wmd==False:
        nltk.download('stopwords', download_dir='./nltkgensimdata/')
    ...
    if save_results:
        if path_results is not None:
            ...
            savepath = Path(path_results).parent.absolute().joinpath("metrics/results.txt")
